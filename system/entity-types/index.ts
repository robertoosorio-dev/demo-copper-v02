// System-layer entity-type vocabulary — ported from demo.v01 frontend/src/components/mediaGraph/schema.js
// This is hardcoded system knowledge, not versioned project data.
// Read-only at runtime; updated only by admin tooling.

export const EXTERNAL_TYPES = new Set(["Campaign", "AdGroup"]);

// Column order left→right for media tree-of-grids views; fence drawn after AdGroup
...
// Type metadata — colors, labels, id prefixes
...
// Per-type column definitions for grid tables
export const COLS: Record<string, Array<{ k: string; l: string; w: number }>> = {
  Campaign: [
    { k: "name",      l: "Campaign",  w: 200 },
    { k: "partner",   l: "Partner",   w: 90  },
    { k: "objective", l: "Objective", w: 110 },
    { k: "extId",     l: "Ext ID",    w: 110 },
    { k: "status",    l: "Status",    w: 80  },
  ],
  AdGroup: [
    { k: "name",     l: "Ad Group", w: 200 },
    { k: "campaign", l: "Campaign", w: 170 },
    { k: "extId",    l: "Ext ID",   w: 110 },
    { k: "status",   l: "Status",   w: 80  },
  ],
  MediaPartner: [
    { k: "name",          l: "Partner",     w: 170 },
    { k: "connector",     l: "Connector",   w: 150 },
    { k: "clickTracking", l: "Click Track", w: 80  },
    { k: "status",        l: "Status",      w: 80  },
    { k: "createdBy",     l: "Created By",  w: 90  },
  ],
  PlacementGroup: [
    { k: "name",       l: "Name",       w: 190 },
    { k: "seat",       l: "Seat",       w: 110 },
    { k: "advertiser", l: "Advertiser", w: 90  },
    { k: "campaign",   l: "Campaign",   w: 160 },
    { k: "status",     l: "Status",     w: 80  },
  ],
  Placement: [
    { k: "name",          l: "Name",          w: 200 },
    { k: "size",          l: "Size",          w: 80  },
    { k: "deliveryFormat",l: "Format",        w: 130 },
    { k: "creativeUnit",  l: "Creative Unit", w: 90  },
    { k: "dspCreativeId", l: "DSP Creative",  w: 100 },
    { k: "status",        l: "Status",        w: 80  },
  ],
  ExperienceGroup: [
    { k: "name",          l: "Name",           w: 185 },
    { k: "creativeUnit",  l: "Creative Unit",  w: 90  },
    { k: "servingStatus", l: "Serving",        w: 80  },
    { k: "currentFlight", l: "Current Flight", w: 145 },
    { k: "impressions",   l: "Imps",           w: 80  },
    { k: "status",        l: "Status",         w: 80  },
  ],
  Creative: [
    { k: "name",         l: "Name",         w: 190 },
    { k: "creativeUnit", l: "Creative Unit",w: 90  },
    { k: "sizes",        l: "Sizes",        w: 110 },
    { k: "costType",     l: "Cost Type",    w: 120 },
    { k: "qaStatus",     l: "QA",           w: 80  },
    { k: "status",       l: "Status",       w: 80  },
  ],
  LandingPageGroup: [
    { k: "name",        l: "Name",        w: 165 },
    { k: "scope",       l: "Scope",       w: 90  },
    { k: "description", l: "Description", w: 210 },
    { k: "status",      l: "Status",      w: 80  },
  ],
  LandingPage: [
    { k: "condition", l: "Condition", w: 100 },
    { k: "weight",    l: "Weight",    w: 60  },
    { k: "url",       l: "URL",       w: 240 },
    { k: "status",    l: "Status",    w: 80  },
  ],
  Pixel: [
    { k: "name",             l: "Pixel",   w: 165 },
    { k: "scope",            l: "Scope",   w: 80  },
    { k: "tracksInteraction",l: "Tracks",  w: 100 },
    { k: "pixelType",        l: "Type",    w: 90  },
    { k: "targetingType",    l: "Targets", w: 80  },
    { k: "status",           l: "Status",  w: 80  },
  ],
};

// Legal adjacency — type pairs that can connect (bidirectional)
